...
class SPAutoEmbed {
  ...
  public function __construct() {
    global $SPAutoEmbed_stubs;

    include_once(SERMONPRESS_DIR . 'inc/embed/stubs.php');
  }
  ...
  public function parseUrl($url) {
    ...
    foreach ($SPAutoEmbed_stubs as $stub) {
  ...
  private function _buildiFrame() {
    ...
    if(isset($this->_stub['code']) && $this->_stub['code'] == 'yt'){
        return sprintf('<iframe width="%s" height="%s" src="%s" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>', $width, $height, $source);
    } else {
        return sprintf('<iframe type="text/html" width="%s" height="%s" src="%s" allowfullscreen="true" frameborder="0"></iframe>', $width, $height, $source);
    }
  }
